...
{
       0,   229,   229,   242,   243,   247,   248,   252,   253,   254,
     258,   259,   260,   261,   265,   266,   270,   271,   271,   288,
     289,   293,   294,   298,   302,   302,   306,   307,   311,   312,
     313,   314,   315,   316,   321,   322,   323,   324,   325,   329,
     330,   334,   335
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MENOR", "MAYOR", "PUNTO", "MAS", "MENOS", "MULT", "DIV", "$accept",
...
{
     -21,     7,    19,   -21,    -4,     9,    31,    32,   -21,   -21,
     -21,    13,   -21,   -21,    33,    26,    -8,    24,   -21,    12,
     -21,   -21,   -21,   -21,   -21,   -21,    35,    36,    20,   -21,
      27,    25,   -21,    29,    39,   -21,   -21,   -21,    -2,     6,
      42,    43,    34,   -21,   -21,   -21,   -21,    45,    46,    37,
      38,    47,   -21,   -20,    40,   -21,    44,    41,   -21,   -21,
      48,     8,    49,    50,    53,    57,   -21,    51,    58,    52,
...
static const yytype_int8 yydefact[] =
{
      ...
      11,    12,    10,    16,    17,     7,     0,    19,     0,    21,
       ...
       0,     0,     0,    24,    23,    33,    26,     0,    39,     0,
       0,     0,    27,    34,     0,    41,     0,    40,    28,    31,
       0,     0,     0,     0,     0,     0,    29,     0,     0,     0,
      25,    35,    36,    37,    38,    30,    42,    32
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -21,   -21,   -21,   -21,   -21,   -21,   -21,    54,   -21,   -21,
     -21,   -21,   -18,   -21,    11,   -21,   -21,   -21,   -21
};
...
#line 1387 "parser.tab.c"
  ...
  case 17: /* $@1: %empty  */
#line 271 "parser.y"
                     { agregar_funcion((yyvsp[-1].str), -1); entrar_ambito(); }
...
#line 293 "parser.y"
         { agregar_variable((yyvsp[0].str), TIPO_INT); (yyval.num) = 1; }
#line 1428 "parser.tab.c"
    break;

  case 22: /* lista_param: lista_param COMA ID  */
#line 294 "parser.y"
                          { agregar_variable((yyvsp[0].str), TIPO_INT); (yyval.num) = (yyvsp[-2].num) + 1; }
...
#line 312 "parser.y"
                                    { verificar_variable_declarada((yyvsp[-3].str)); }
...
#line 1482 "parser.tab.c"
  ...
  case 35: /* expresion: ID MAS ID  */
#line 322 "parser.y"
                { verificar_uso_variable((yyvsp[-2].str)); verificar_uso_variable((yyvsp[0].str)); }
#line 1488 "parser.tab.c"
    break;

  case 36: /* expresion: ID MENOS ID  */
#line 323 "parser.y"
                  { verificar_uso_variable((yyvsp[-2].str)); verificar_uso_variable((yyvsp[0].str)); }
#line 1494 "parser.tab.c"
    break;

  case 37: /* expresion: ID MULT ID  */
#line 324 "parser.y"
                 { verificar_uso_variable((yyvsp[-2].str)); verificar_uso_variable((yyvsp[0].str)); }
#line 1500 "parser.tab.c"
    break;

  case 38: /* expresion: ID DIV ID  */
#line 325 "parser.y"
                { verificar_uso_variable((yyvsp[-2].str)); verificar_uso_variable((yyvsp[0].str)); }
...
#line 1512 "parser.tab.c"
  ...
  case 40: /* argumentos: lista_args  */
#line 330 "parser.y"
                 { (yyval.num) = (yyvsp[0].num); }
#line 1518 "parser.tab.c"
    break;

  case 41: /* lista_args: ID  */
#line 334 "parser.y"
         { verificar_uso_variable((yyvsp[0].str)); (yyval.num) = 1; }
#line 1524 "parser.tab.c"
    break;

  case 42: /* lista_args: lista_args COMA ID  */
#line 335 "parser.y"
                         { verificar_uso_variable((yyvsp[0].str)); (yyval.num) = (yyvsp[-2].num) + 1; }
